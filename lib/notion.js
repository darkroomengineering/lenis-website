...
function RichTextElement({ richText }) {
  ...
  switch (type) {
    case 'text': {
      ...
      if (href) {
        content = textContent && (
          <Link href={addUtmSource(href)}>{textContent}</Link>
        )
      } else {
    ...
    case 'mention': {
      ...
      if (href) {
        content = mentionContent && (
          <Link href={addUtmSource(href)}>{mentionContent}</Link>
        )
      } else {
    ...
    case 'equation': {
      ...
      if (href) {
        content = expression && (
          <Link href={addUtmSource(href)}>{expression}</Link>
        )
      } else {
    ...
    default:
      ...
      if (href) {
        content = plain_text && (
          <Link href={addUtmSource(href)}>{plain_text}</Link>
        )
      } else {
